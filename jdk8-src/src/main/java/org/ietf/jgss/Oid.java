...
public class Oid {
     ...
     * @throws GSSException may be thrown when the string is incorrectly
     *                      formatted
     */
     ...
     * @throws GSSException may be thrown when the DER encoding does not
     ...
     * @throws GSSException may be thrown when the oid can't be encoded
     */

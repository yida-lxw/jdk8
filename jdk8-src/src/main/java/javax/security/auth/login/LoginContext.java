...
public class LoginContext {
     ...
     *             {@code Configuration}.
     * @throws LoginException    if the caller-specified {@code name}
     ...
     *                           <p>
     * @throws SecurityException if a SecurityManager is set and
     ...
     *                           for "<i>other</i>".
     *                           <p>
     * @throws SecurityException if a SecurityManager is set,

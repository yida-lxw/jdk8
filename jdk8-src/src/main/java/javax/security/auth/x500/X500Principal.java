...
public final class X500Principal implements Principal, java.io.Serializable {
     ...
     *                                  is {@code null}
     * @throws IllegalArgumentException if the {@code name}
     ...
     * @throws IllegalArgumentException if the {@code name} is
     ...
     * @throws NullPointerException     if the {@code InputStream}
     *                                  is {@code null}
     * @throws IllegalArgumentException if an encoding error occurs
     *                                  (incorrect form for DN)
     */

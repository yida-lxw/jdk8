...
public class MediaSize extends Size2DSyntax implements Attribute {
     ...
     * @param x     X dimension.
     * @param y     Y dimension.
     * @param units Unit conversion factor, e.g. <CODE>Size2DSyntax.INCH</CODE> or
     *              <CODE>Size2DSyntax.MM</CODE>.
     * @throws IllegalArgumentException (Unchecked exception) Thrown if {@code x < 0} or {@code y < 0} or

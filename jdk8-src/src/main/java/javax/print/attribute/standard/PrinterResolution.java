...
public final class PrinterResolution extends ResolutionSyntax
     ...
     * @param units               Unit conversion factor, e.g. <code>ResolutionSyntax.DPI</CODE>
     *                            or <code>ResolutionSyntax.DPCM</CODE>.
     * @throws IllegalArgumentException (unchecked exception) Thrown if {@code crossFeedResolution < 1} or

...
public final class PageRanges extends SetOfIntegerSyntax
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if <CODE>members</CODE> is null or
     *                                  any element of <CODE>members</CODE> is null.
     * @throws IllegalArgumentException (Unchecked exception) Thrown if <CODE>members</CODE> does not
     ...
     * @throws IllegalArgumentException (Unchecked exception) Thrown if <CODE>member</CODE> is less than
     *                                  1.
     */
     ...
     * @throws IllegalArgumentException (Unchecked exception) Thrown if a null range is specified or if a

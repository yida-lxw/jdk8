...
public interface PrintService {
     ...
     * @throws IllegalArgumentException (unchecked exception) if <CODE>category</CODE> is not a
     ...
     * @throws NullPointerException (unchecked exception) Thrown if <CODE>flavor</CODE> is null.
     */
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if <CODE>category</CODE> is null.
     * @throws IllegalArgumentException (unchecked exception) Thrown if <CODE>category</CODE> is not a
     *                                  <code>Class</code> that implements interface
     *                                  {@link javax.print.attribute.Attribute Attribute}.
     */
    public boolean
     ...
     * @throws NullPointerException     (unchecked exception)  if <CODE>attrval</CODE> is null.
     * @throws IllegalArgumentException if flavor is not supported by
     *                                  this PrintService.
     */
     ...
     * @throws IllegalArgumentException if<CODE>flavor</CODE> is

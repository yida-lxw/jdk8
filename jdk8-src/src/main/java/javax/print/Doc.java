...
public interface Doc {
     ...
     * @throws IOException Thrown if the representation class is a stream and there was an I/O
     ...
     * @throws IOException Thrown if there was an I/O error while creating the reader.
     */
     ...
     * @throws IOException Thrown if there was an I/O error while creating the input stream.
     */

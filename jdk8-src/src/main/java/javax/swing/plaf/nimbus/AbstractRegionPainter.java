...
public abstract class AbstractRegionPainter implements Painter<JComponent> {
    ...
    */
     ...
     * @throws IllegalArgumentException if {@code x < 0} or {@code x > 3}
     */
     ...
     * @throws IllegalArgumentException if {@code y < 0} or {@code y > 3}
     */
     ...
     * @throws NullPointerException     if {@code midpoints} array is null,

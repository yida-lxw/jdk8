...
public class SynthComboBoxUI extends BasicComboBoxUI implements
    ...
    private final class ButtonHandler extends DefaultButtonModel
        ...
        /**
         * @inheritDoc Ensures that isPressed() will return true if the combo is pressed,
        ...
        /**
         * @inheritDoc Ensures that the armed state is in sync with the pressed state
        ...
        /**
         * @inheritDoc Ensures that isRollover() will return true if the combo is
        ...
        /**
         * @inheritDoc Ensures that the combo box is repainted when the popup is closed.

...
public class JDialog extends Dialog implements WindowConstants,
     ...
     * @throws IllegalArgumentException if the {@code owner} is not an instance of {@link java.awt.Dialog Dialog}
     ...
     * @throws IllegalArgumentException if the {@code owner}'s {@code GraphicsConfiguration} is not from a screen device
     * @throws HeadlessException        when {@code GraphicsEnvironment.isHeadless()} returns {@code true}
     * @throws SecurityException        if the calling thread does not have permission to create modal dialogs

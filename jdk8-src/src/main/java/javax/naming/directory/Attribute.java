...
public interface Attribute extends Cloneable, java.io.Serializable {
     ...
     * is returned.
     * @throws NamingException If a naming exception was encountered while retrieving
     *                         the values.
     * @see #isOrdered
     */
     ...
     * @throws NamingException                  If a naming exception was encountered while retrieving
     *                                          the value.
     * @throws java.util.NoSuchElementException If this attribute has no values.
     */
     ...
     * @throws OperationNotSupportedException If getting the schema
     *                                        is not supported.
     * @throws NamingException                If a naming exception occurs while getting
     *                                        the schema.
     */
     ...
     * @throws IndexOutOfBoundsException If <tt>ix</tt> is outside the specified range.
     */
     ...
     *                the value added.
     * @throws IndexOutOfBoundsException If <tt>ix</tt> is outside the specified range.
     * @throws IllegalStateException     If the attribute values are unordered and
     ...
     * @throws IndexOutOfBoundsException If <tt>ix</tt> is outside the specified range.
     * @throws IllegalStateException     If <tt>attrVal</tt> already exists and the

...
public interface SOAPFault extends SOAPBodyElement {
     ...
     * @throws SOAPException                 if there was an error in retrieving
     ...
     * @throws SOAPException                 if there was an error in adding the Reason text
     ...
     *
     * @throws SOAPException                 if there was an error in setting the

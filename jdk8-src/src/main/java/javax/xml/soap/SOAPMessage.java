...
public abstract class SOAPMessage {
     ...
     *
     * @param headers a <code>MimeHeaders</code> object containing the MIME
     ...
     *
     * @param AttachmentPart an <code>AttachmentPart</code> object that is to become part
     ...
     *
     * @param dataHandler the <code>javax.activation.DataHandler</code> object that
     ...
     * @throws IllegalArgumentException if there was a problem with the specified <code>DataHandler</code>
     *                                  object
     ...
     *
     * @param content     an <code>Object</code> containing the content for the
     *                    <code>AttachmentPart</code> object to be created
     * @param contentType a <code>String</code> object giving the type of content;
     *                    examples are "text/xml", "text/plain", and "image/jpeg"
     * @return a new <code>AttachmentPart</code> object that contains the
     * given data
     * @throws IllegalArgumentException may be thrown if the contentType does not match the type
     ...
     * <p>
     *
     * @throws <code>SOAPException</code> if there was a problem saving
     ...
     * of the Message
     *
     * @param out the <code>OutputStream</code> object to which this <code>SOAPMessage</code>

...
public interface SOAPBody extends SOAPElement {
     ...
     * @param locale      a {@link java.util.Locale Locale} object indicating the
     ...
     * child element.
     *
     * @param faultCode   a <code>Name</code> object giving the fault code to be set;
     ...
     *
     * @param qname a <code>QName</code> object with the qname for the new
     ...
     * @throws SOAPException if there is not exactly one child <code>SOAPElement</code> of the <code>
     *                       <code>SOAPBody</code>.
     * @since SAAJ 1.3
     */

...
public interface SOAPElement extends Node, org.w3c.dom.Element {
     ...
     *                  the new element
     * @return the new <code>SOAPElement</code> object that was created
     * @throws SOAPException if the <code>prefix</code> is not valid in the
     ...
     *
     * @param localName a <code>String</code> containing the local part of the name.
     * @param prefix    a <code>String</code> containing the prefix for the name.
     ...
     * @throws SOAPException if the <code>QName</code> cannot be created.
     * @since SAAJ 1.3
     */
     ...
     * @throws SOAPException if changing the name of this <code>Element</code>
     *                       is not allowed.
     * @since SAAJ 1.3
     */
     ...
     * @throws SOAPException            if setting the encodingStyle is invalid for this SOAPElement.

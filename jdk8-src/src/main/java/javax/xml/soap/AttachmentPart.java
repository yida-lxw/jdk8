...
public abstract class AttachmentPart {
     ...
     * @throws SOAPException if the content of this attachment is
     ...
     *                    the content
     * @throws IllegalArgumentException may be thrown if the contentType
     ...
     * @throws SOAPException if there is no data in

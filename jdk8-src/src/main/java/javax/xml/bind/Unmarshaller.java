...
public interface Unmarshaller {
     ...
     *                                  <tt>Unmarshaller</tt> is unable to perform the XML to Java
     *                                  binding.  See <a href="#unmarshalEx">Unmarshalling XML Data</a>
     * @throws IllegalArgumentException If the URL parameter is null
     */
     ...
     *                                  <tt>Unmarshaller</tt> is unable to perform the XML to Java
     *                                  binding.  See <a href="#unmarshalEx">Unmarshalling XML Data</a>
     * @throws IllegalArgumentException If the InputSource parameter is null
     */
     ...
     *                                  <tt>Unmarshaller</tt> is unable to perform the XML to Java
     *                                  binding.  See <a href="#unmarshalEx">Unmarshalling XML Data</a>
     * @throws IllegalArgumentException If the <tt>reader</tt> parameter is null
     * @throws IllegalStateException    If <tt>reader</tt> is not pointing to a START_DOCUMENT or
     *                                  START_ELEMENT  event.
     ...
     *
     * @param reader       The parser to be read.
     * @param declaredType appropriate JAXB mapped class to hold <tt>reader</tt>'s START_ELEMENT XML data.
     ...
     * @throws UnsupportedOperationException if invoked agains a JAXB 1.0 implementation.
     ...
     *                refers to this type.
     * @param adapter The instance of the adapter to be used. If null, it will un-register

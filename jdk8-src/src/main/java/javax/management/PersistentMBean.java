...
public interface PersistentMBean {
     ...
     *
     * @throws MBeanException             Wraps another exception or persistence is not supported
     * @throws RuntimeOperationsException Wraps exceptions from the persistence mechanism
     * @throws InstanceNotFoundException  Could not find or load this MBean from persistent
     *                                    storage
     */
    public void load()
     ...
     * @throws MBeanException             Wraps another exception or persistence is not supported
     * @throws RuntimeOperationsException Wraps exceptions from the persistence mechanism
     * @throws InstanceNotFoundException  Could not find/access the persistent store
     */
    public void store()
            throws MBeanException, RuntimeOperationsException, InstanceNotFoundException;

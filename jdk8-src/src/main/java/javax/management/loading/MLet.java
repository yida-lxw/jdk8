...
public class MLet extends java.net.URLClassLoader
     ...
     *                                  null.
     * @throws IllegalStateException    MLet MBean is not registered with an MBeanServer.
     */
     ...
     *                                  malformed.
     * @throws IllegalStateException    MLet MBean is not registered
     *                                  with an MBeanServer.
     */
     ...
     * by the MBean server.
     *
     * @throws java.lang.Exception This exception should be caught
     ...
     * @throws Exception if the MBean is not to be loaded for some
     ...
     * @throws IOException            An I/O error occurred while loading
     *                                serialized object.
     */

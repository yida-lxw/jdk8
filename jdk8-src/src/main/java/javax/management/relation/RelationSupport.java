...
public class RelationSupport
     ...
     * @throws InvalidRoleValueException if the same name is used for two
     *                                   roles.
     ...
     * @throws RoleNotFoundException                 if there is no role with the supplied
     *                                               role's name or if the role is not writable (no test on the write access
     *                                               mode performed when initializing the role)
     * @throws InvalidRoleValueException             if value provided for
     ...
     * @throws RelationServiceNotRegisteredException if the Relation
     *                                               Service is not registered in the MBean Server
     * @throws RelationTypeNotFoundException         if the relation type has not
     *                                               been declared in the Relation Service
     * @throws RelationNotFoundException             if the relation has not been
     ...
     * @throws RelationTypeNotFoundException         if the relation type has not
     *                                               been declared in the Relation Service.
     * @throws RelationNotFoundException             if the relation MBean has not been
     *                                               added in the Relation Service.
     * @see #getRoles
     */
     ...
     * @throws RoleNotFoundException                 if role does not exist in the
     *                                               relation or is not writable
     * @throws InvalidRoleValueException             if role value does not conform to
     ...
     * @throws RelationTypeNotFoundException         if the relation type has not
     *                                               been declared in the Relation Service.
     * @throws RelationNotFoundException             if this method is called for a

...
public class RoleInfo implements Serializable {
     ...
     * @throws InvalidRoleInfoException   if the minimum degree is
     *                                    greater than the maximum degree.
     * @throws ClassNotFoundException     As of JMX 1.2, this exception
     *                                    can no longer be thrown.  It is retained in the declaration of
     *                                    this class for compatibility with existing code.
     * @throws NotCompliantMBeanException if the class mbeanClassName
     ...
     *                                    can no longer be thrown.  It is retained in the declaration of
     *                                    this class for compatibility with existing code.
     * @throws NotCompliantMBeanException As of JMX 1.2, this

...
public class RelationService extends NotificationBroadcasterSupport
     ...
     * MBean Server
     *
     * @throws RelationServiceNotRegisteredException if it is not
     *                                               registered
     */
     ...
     * @throws InvalidRelationTypeException If:
     ...
     * @throws IllegalArgumentException     if null parameter or if
     ...
     * @throws IllegalArgumentException      if null parameter
     * @throws RelationTypeNotFoundException if the relation type is not
     *                                       known in the Relation Service
     * @throws RoleInfoNotFoundException     if the role is not part of the
     *                                       relation type.
     */
     ...
     * @throws RelationServiceNotRegisteredException if the Relation
     *                                               Service is not registered in the MBean Server
     * @throws IllegalArgumentException              if null parameter, except the role
     *                                               list which can be null if no role initialization
     * @throws RoleNotFoundException                 if a value is provided for a role
     *                                               that does not exist in the relation type
     * @throws InvalidRelationIdException            if relation id already used
     * @throws RelationTypeNotFoundException         if relation type not known in
     *                                               Relation Service
     * @throws InvalidRoleValueException             if:
     ...
     *                                               Relation interface
     * @throws InvalidRelationIdException            if:
     *                                               <P>- no relation identifier in MBean
     *                                               <P>- the relation identifier is already used in the Relation Service
     * @throws InstanceNotFoundException             if the MBean for given ObjectName
     *                                               has not been registered
     * @throws InvalidRelationServiceException       if:
     ...
     * @throws RelationTypeNotFoundException         if:
     ...
     * @throws IllegalArgumentException  if null parameter
     * @throws RelationNotFoundException there is no relation associated
     *                                   to that id
     */
     ...
     * @throws IllegalArgumentException  if null parameter
     * @throws RelationNotFoundException if there is no relation for given
     *                                   relation id
     */
     ...
     *                                               Service is not registered in the MBean Server
     * @throws IllegalArgumentException              if null parameter
     * @throws RelationNotFoundException             if no relation corresponding to
     *                                               given relation id
     */
     ...
     * @throws RoleNotFoundException                 if:
     ...
     * @throws IllegalArgumentException              if null parameter
     * @throws RelationNotFoundException             if no relation with given id
     * @throws RoleNotFoundException                 if the role does not exist or is not
     *                                               writable
     * @throws InvalidRoleValueException             if value provided for role is not
     *                                               valid:
     *                                               <P>- the number of referenced MBeans in given value is less than
     *                                               expected minimum degree
     *                                               <P>or
     ...
     * @throws IllegalArgumentException  if null parameter
     * @throws RelationNotFoundException if no relation for given
     *                                   relation id
     */
    public Map<ObjectName, List<String>>

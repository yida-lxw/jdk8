...
public abstract class RMIServerImpl implements Closeable, RMIServer {
     ...
     *                               created or exported.
     * @throws SecurityException     if the given credentials do not allow
     *                               the server to authenticate the user successfully.
     * @throws IllegalStateException if {@link #getMBeanServer()}
     *                               is null.
     */
     ...
     * @throws IOException if the client connection cannot be
     *                     closed.
     */
     ...
     * @throws IOException          if {@link #closeClient} throws this
     *                              exception.
     ...
     * from this method.</p>
     *
     * @throws IOException if {@link #closeServer()} or one of the

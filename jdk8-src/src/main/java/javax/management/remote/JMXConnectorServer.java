...
public abstract class JMXConnectorServer
     ...
     * @throws IllegalStateException         if the JMXConnectorServer is
     *                                       not started (see {@link JMXConnectorServerMBean#isActive()}).
     * @throws IOException                   if a communications problem means that a
     ...
     * @throws NullPointerException if <code>connectionId</code> is
     *                              null.
     */
     ...
     *                     {@link JMXConnectionNotification}.  Can be null.  See {@link
     *                     Notification#getUserData()}.
     * @throws NullPointerException if <code>connectionId</code>
     *                              is null.
     */
     ...
     * @throws NullPointerException if <code>mbs</code> or

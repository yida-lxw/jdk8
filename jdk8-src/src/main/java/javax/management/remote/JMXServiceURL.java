...
public class JMXServiceURL implements Serializable {
     ...
     * @throws NullPointerException  if <code>serviceURL</code> is
     *                               null.
     * @throws MalformedURLException if <code>serviceURL</code>
     ...
     * @throws MalformedURLException if one of the parts is

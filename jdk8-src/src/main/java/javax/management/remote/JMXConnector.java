...
public interface JMXConnector extends Closeable {
     ...
     * @throws SecurityException if the connection could not be
     ...
     * @throws IOException if a valid <code>MBeanServerConnection</code>
     ...
     * @throws IOException if the connection ID cannot be obtained,

...
import static java.text.DateFormatSymbols.PATTERN_AM_PM;
import static java.text.DateFormatSymbols.PATTERN_DAY_OF_WEEK;
import static java.text.DateFormatSymbols.PATTERN_ERA;
import static java.text.DateFormatSymbols.PATTERN_HOUR1;
import static java.text.DateFormatSymbols.PATTERN_HOUR_OF_DAY1;
import static java.text.DateFormatSymbols.PATTERN_ISO_ZONE;
import static java.text.DateFormatSymbols.PATTERN_MONTH;
import static java.text.DateFormatSymbols.PATTERN_MONTH_STANDALONE;
import static java.text.DateFormatSymbols.PATTERN_WEEK_YEAR;
import static java.text.DateFormatSymbols.PATTERN_YEAR;
import static java.text.DateFormatSymbols.PATTERN_ZONE_NAME;
import static java.text.DateFormatSymbols.PATTERN_ZONE_VALUE;

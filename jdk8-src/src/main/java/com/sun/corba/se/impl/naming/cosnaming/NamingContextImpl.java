...
public abstract class NamingContextImpl
     ...
     * @throws org.omg.CosNaming.NamingContextPackage.NotFound      A name with
     *                                                              multiple components was supplied, but the first component could not be
     *                                                              resolved.
     * @throws org.omg.CosNaming.NamingContextPackage.CannotProceed Could
     *                                                              not proceed in resolving the n-1 components of the supplied name.
     * @throws org.omg.CosNaming.NamingContextPackage.InvalidName   The
     *                                                              supplied name is invalid (i.e., has length less than 1).
     * @throws org.omg.CosNaming.NamingContextPackage.AlreadyBound  An object
     ...
     *                                                              multiple components was supplied, but the first component could not be
     *                                                              resolved.
     * @throws org.omg.CosNaming.NamingContextPackage.CannotProceed Could not
     ...
     *
     * @throws org.omg.CosNaming.NamingContextPackage.NotEmpty This
     ...
     *                                                              multiple components was supplied, but the first component could not be
     *                                                              resolved.
     * @throws org.omg.CosNaming.NamingContextPackage.CannotProceed Could not     * proceed
     ...
     *                                                              proceed
     *                                                              in resolving the first component of the supplied name.
     * @throws org.omg.CosNaming.NamingContextPackage.InvalidName   The supplied
     *                                                              name is invalid (i.e., has length less than 1).
     * @throws org.omg.CORBA.SystemException                        One of a fixed set of CORBA system
     *                                                              exceptions.
     * @see resolve
     */
     ...
     * @param impl an implementation of NamingContextDataStore
     * @param n    a sequence of NameComponents which is the name to be unbound.
     * @throws org.omg.CosNaming.NamingContextPackage.NotFound      A name with multiple
     *                                                              components was supplied, but the first component could not be
     *                                                              resolved.
     * @throws org.omg.CosNaming.NamingContextPackage.CannotProceed Could not proceed
     *                                                              in resolving the n-1 components of the supplied name.
     * @throws org.omg.CosNaming.NamingContextPackage.InvalidName   The supplied name
     ...
     * @throws org.omg.CosNaming.NamingContextPackage.NotFound      The
     ...
     * @throws org.omg.CosNaming.NamingContextExtPackage.InvalidName Indicates the name does not identify a binding.<p>
     * @throws org.omg.CosNaming.NamingContextPackage.AlreadyBound   Indicates the name is already bound.<p>
     */

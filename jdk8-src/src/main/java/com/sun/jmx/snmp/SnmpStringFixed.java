...
public class SnmpStringFixed extends SnmpString {
     ...
     * @param v The <CODE>bytes</CODE> composing the fixed-string value.
     * @throws IllegalArgumentException Either the length or the <CODE>byte</CODE> array is not valid.
     */
     ...
     * @throws IllegalArgumentException Either the length or the <CODE>String</CODE> is not valid.
     */
     ...
     * @throws SnmpStatusException There is no string value

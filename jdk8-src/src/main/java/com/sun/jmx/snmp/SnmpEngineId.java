...
public class SnmpEngineId implements Serializable {
     ...
     * @throws UnknownHostException     if the host name contained in the textual format is unknown.
     * @throws IllegalArgumentException when :
     *                                  <ul>
     *                                   <li>octet string lower than 5 bytes.</li>
     *                                   <li>octet string greater than 32 bytes.</li>
     ...
     *                  separator ":" is used.
     * @return The generated engine Id or null if the passed string is null.
     * @throws UnknownHostException     if the host name contained in the
     ...
     * @return The generated engine Id.
     * @throws UnknownHostException if the local host name
     ...
     * @param port    The TCP/IP port the SNMPv3 Adaptor Server is listening to.
     * @return The generated engine Id.
     * @throws UnknownHostException. if the provided address is null.
     */
     ...
     * @return The generated engine Id.
     * @throws UnknownHostException if the local host name used to calculate the id is unknown.
     */
     ...
     * @param iana Your enterprise IANA number.
     * @return The generated engine Id.
     * @throws UnknownHostException if the provided <CODE>InetAddress </CODE> is null.
     */
     ...
     * @param addr The IP address the SNMPv3 Adaptor Server is listening to.
     * @return The generated engine Id.
     * @throws UnknownHostException if the provided

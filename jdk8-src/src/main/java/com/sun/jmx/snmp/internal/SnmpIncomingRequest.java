...
public interface SnmpIncomingRequest {
     ...
     * @throws SnmpStatusException If the specified bytes are not a valid encoding or if the security applied to this request failed and no report is to be sent (typically trap PDU).
     */
     ...
     * @throws SnmpStatusException            If the specified <CODE>pdu</CODE>
     *                                        is not valid.

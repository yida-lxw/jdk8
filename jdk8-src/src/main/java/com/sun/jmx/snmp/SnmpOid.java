...
public class SnmpOid extends SnmpValue {
     ...
     * @throws IllegalArgumentException The subidentifier is neither a numeric <CODE>String</CODE>
     ...
     * @throws SnmpStatusException No OID arc was found at the requested
     *                             position.
     */
     ...
     * @throws SnmpStatusException There is no OID value
     ...
     * @throws SnmpStatusException An error occurred while accessing a MIB node.
     */
     ...
     * @return The value 0 if the parameter <CODE>other</CODE> is equal to this <CODE>SnmpOid</CODE>.
     ...
     * @throws SnmpStatusException If the variable is not found in the MIB database.
     */

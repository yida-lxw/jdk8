...
public class SnmpOidDatabaseSupport implements SnmpOidDatabase {
     ...
     * @throws SnmpStatusException The specified <CODE>SnmpOidTable</CODE> does not exist in this <CODE>SnmpOidDatabase</CODE>.
     */
     ...
     * @throws SnmpStatusException The specified name does not exist in this <CODE>SnmpOidDatabase</CODE>
     */
     ...
     * @return The <CODE>SnmpOidRecord</CODE> object containing information on the variable.
     * @throws SnmpStatusException The specified oid does not exist in this <CODE>SnmpOidDatabase</CODE>.
     */

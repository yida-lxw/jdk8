...
public class SnmpAdaptorServer extends CommunicatorServer
     ...
     * @throws SnmpStatusException If the trap exceeds the limit defined
     ...
     * @param time        The time stamp (overwrite the current time).
     * @throws IOException         An I/O error occurred while sending the trap.
     * @throws SnmpStatusException If the trap exceeds the limit
     ...
     * @throws IOException           An I/O error occurred while sending the
     *                               inform request.
     * @throws SnmpStatusException   If the inform request exceeds the
